...
class ApplicationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.workPlace.pages.applications.index', compact('contents', 'sortedMenu', 'applicationTypes'));
    }
    ...
    public function getTab($tab)
    {
        ...
        $content = view('web.workPlace.pages.applications.tabs', compact('applications', 'publicApplicationsCount', 'mostVisitedApplication'))->render();
